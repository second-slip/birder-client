...
describe('ObservationCountComponent unit tests', () => {
    ...
    const setup = async (fakePropertyValues?: jasmine.SpyObjPropertyNames<ObservationCountService>) => {
    ...
    describe('when service returns success response', () => {
        ...
        describe('when count is 0', async () => {
            ...
            it('should render the analysis section for count = 0', async () => {
                ...
                expect(compiled.querySelector('[data-testid="analysis-count-zero"]')?.textContent).toContain('You have not yet logged any observations');
        ...
        describe('when count is > 0', () => {
            ...
            it('should render the analysis section with count from service response', async () => {
                ...
                const compiled = fixture.nativeElement as HTMLElement;
                expect(compiled.querySelector('[data-testid="analysis-text"]')?.textContent).toBeDefined();
                ...
                expect(compiled.querySelector('[data-testid="analysis-text"]')?.textContent).toBe(expectedText);
    ...
    describe('when service returns error response', () => {
        ...
        it('hides main content', async () => {
            ...
            const compiled = fixture.nativeElement as HTMLElement;
            expect(compiled.querySelector('[data-testid="analysis-text"]')).toBeFalsy()
            expect(compiled.querySelector('[data-testid="analysis-count-zero"]')).toBeFalsy();
        });
        ...
        it('should load Try Again button', async () => {
            ...
            const button = await loader.getAllHarnesses(MatButtonHarness.with({ text: 'Try Again' }));
            expect(button.length).toBe(1);
