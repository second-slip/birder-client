...
describe('AuthenticationService', () => {
  ...
  const setup = async (
    fakeJwtReturnValues?: jasmine.SpyObjMethodNames<JwtHelperService>,
  ...
  describe('when checkAuthStatus()', () => {
    it('gets user and true status when authenticated', async () => {
      await setup(
        {
    ...
    it('gets null and false status when not authenticated', async () => {
      await setup(
        {},
        {
          getToken: null,
  ...
  describe('when IsLoggedIn() is called ', () => {
    it('should return false and redirect to Home when token is invalid', async () => {
      await setup(
        {},
        {
          getToken: '',
  ...
  describe('when logout() is called', () => {
    it('should remove the toekn and update auth status', async () => {
      await setup(
        {},
        {
          getToken: null,
