...
describe('FollowersComponent', () => {
    ...
    await TestBed.configureTestingModule({
      ...
      .overrideComponent(FollowersComponent, {
        remove: {
          ...
          providers: [FollowersService, AuthenticationService],
        },
        add: {
          imports: [MockComponent(NetworkUserComponent)],
          providers: [{ provide: FollowersService, useValue: fakeService }],
        },
      })
      .compileComponents();
  ...
  describe('when response is successful', () => {
    ...
    it('shows the followers list when followers > 0', async () => {
      await setup(
        {},
        {
          isError: of(false),
    ...
    it('shows the no followers content when followers = 0 ([])', async () => {
      await setup(
        {},
        {
          isError: of(false),
