...
describe('FollowingComponent', () => {
    ...
    await TestBed.configureTestingModule({
      ...
      .overrideComponent(FollowingComponent, {
        ...
        add: {
          ...
          providers: [{ provide: FollowingService, useValue: fakeService }],
        },
      })
      .compileComponents();
  ...
  describe('when response is successful', () => {
    ...
    it('shows the following list when following > 0', async () => {
      await setup(
        {},
        {
          isError: of(false),
      ...
      expect(
        compiled.querySelector('[data-testid="following-list"]')?.textContent
      ).toBeDefined();
      expect(
        compiled.querySelector('[data-testid="following-list-is-zero"]')
          ?.textContent
      ).toBeUndefined();
    });

    it('shows the no following content when following = 0 ([])', async () => {
      await setup(
        {},
        {
          isError: of(false),
