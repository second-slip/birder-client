...
describe('TweetDayComponent unit tests', () => {
  ...
  describe('TweetDayComponent service is called successfully', () => {
    ...
    it('should render the Tweet', () => {
      ...
      expect(
        compiled.querySelector('[data-testid="main-title"]')?.textContent
      ).toContain('Tweet of the Day');
      expect(
        compiled.querySelector('[data-testid="english-name"]')?.textContent
      ).toContain('Lapwing');
      expect(
        compiled.querySelector('[data-testid="scientific-name"]')?.textContent
      ).toContain('Vanellus vanellus');
    });
